...
async function findAllAssignments() {
  const { rows } = await pool.query(
    `SELECT va.*,
            ...
            latest_verification.verification_id,
            latest_verification.verification_status,
            latest_verification.verification_decision,
            latest_verification.verification_remarks,
            latest_verification.result_date,
