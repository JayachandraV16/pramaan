...
type Schedule = { id: string; application_id: string; assignment_id: string; application_number?: string; scheduled_date: string; scheduled_time?: string; verification_location?: string; status: string; remarks?: string | null };
